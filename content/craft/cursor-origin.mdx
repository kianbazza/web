...
} from '@/app/craft/2025/cursor-origin/button'
import { Signature } from '@/components/signature'

I saw [this post](https://x.com/merycodes/status/1957184627103375528) on my X timeline and was intrigued.
...
<Frame 
  ...
  mediaProps={{
    src: { 
      light: "https://bazza-dev.b-cdn.net/craft/2025/cursor-origin/craft-2025-cursor-origin--prototype-demo.mp4",
      dark: "https://bazza-dev.b-cdn.net/craft/2025/cursor-origin/craft-2025-cursor-origin--prototype-demo-dark.mp4"
    },
    type: "video",
    width: 2212,
    height: 516,
...
<Frame
  mediaProps={{
    src: { 
      light: "https://bazza-dev.b-cdn.net/craft/2025/cursor-origin/craft-2025-cursor-origin--breakdown-basic-demo-light.mp4",
      dark: "https://bazza-dev.b-cdn.net/craft/2025/cursor-origin/craft-2025-cursor-origin--breakdown-basic-demo-dark.mp4"
    },
    type: "video",
    width: 2212,
    height: 516,
...
<Frame
  mediaProps={{
    src: { 
      light: "https://bazza-dev.b-cdn.net/craft/2025/cursor-origin/craft-2025-cursor-origin--breakdown-pseudo-demo-light.mp4",
      dark: "https://bazza-dev.b-cdn.net/craft/2025/cursor-origin/craft-2025-cursor-origin--breakdown-pseudo-demo-dark.mp4"
    },
    type: "video",
    width: 2212,
    height: 516,
...
> These values are offsets relative to the element’s border box. 
...
<button
  className={cn(
    // ...,
    'before:origin-(--cursor-origin)', // [!code highlight]
    // ...
  )}
  ref={(el) => {
    if (!el) return
