...
export interface PlaybackRateButtonProps extends React.ComponentPropsWithRef<'button'> {
  /**
...
export const PlaybackRateButton = React.forwardRef<HTMLButtonElement, PlaybackRateButtonProps>(
  function PlaybackRateButton(props, forwardedRef) {
    const { rates = DEFAULT_PLAYBACK_RATES, render, onClick, children, ...buttonProps } = props
