...
export const BufferedIndicator = React.forwardRef<HTMLDivElement, BufferedIndicatorProps>(
  function BufferedIndicator(props, forwardedRef) {
    ...
    const bufferedPercentage = context.duration > 0
      ? (bufferedEnd / context.duration) * 100
      : 0
