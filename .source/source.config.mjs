...
var OSCURA = {
  ...
  // default light text
  tag: '#E6E7A3',
  // tags / classes / headings / attrs (yellowish)
  invalid: '#D84F68',
  // errors / deletions / special highlights (red)
  keyword: '#9099A1',
  // keywords / operators / control
  neutral: '#868F97',
  // secondary text / regex / docstrings, etc.
  url: '#479FFA',
  // links
  number: '#F9B98C',
  // numbers / constants / Next.js directives
  attrTeal: '#54C0A3',
  // HTML/CSS attributes
  strMeaningful: '#4EBE96',
  // semantically meaningful string literals
  templateText: '#F6B98B',
  // template-string body text
  bracket: '#5C6974',
  // brackets & delimiters
  mdSeparator: '#65737E',
  // markdown separators
  fencedDim: '#00000050',
  // dim fenced-code markers/backgrounds
}
var oscuraMidnight = {
  ...
  tokenColors: [
    {
      name: 'Comment',
      scope: ['comment', 'punctuation.definition.comment'],
      settings: { foreground: OSCURA2.comment },
    },
    {
      name: 'Variables',
      scope: [
    ...
    },
    {
      name: 'Invalid',
      scope: ['invalid', 'invalid.illegal'],
      settings: { foreground: OSCURA2.invalid },
    },
    {
      name: 'Keyword, Storage',
      scope: ['keyword', 'storage.type', 'storage.modifier'],
      settings: { foreground: OSCURA2.keyword },
    },
    {
      name: 'Operator, Punctuation, Misc',
      scope: [
    ...
    },
    {
      name: 'Tag',
      scope: ['entity.name.tag', 'meta.tag.sgml', 'markup.deleted.git_gutter'],
      settings: { foreground: OSCURA2.tag },
    },
    {
      name: 'Function, Special Method',
      scope: [
    ...
    },
    {
      ...
      settings: { foreground: OSCURA2.number },
    },
    {
      name: 'String, Symbols, Inherited Class',
      scope: [
    ...
    },
    {
      name: 'Language methods',
      scope: ['variable.language'],
      settings: { foreground: OSCURA2.neutral },
    },
    {
      name: 'entity.name.method.js',
      scope: ['entity.name.method.js'],
    ...
    },
    {
      ...
      settings: { foreground: OSCURA2.attrTeal },
    },
    {
      name: 'HTML Attributes',
      scope: [
    ...
    },
    {
      name: 'URL',
      scope: ['*url*', '*link*', '*uri*'],
      settings: { fontStyle: 'underline', foreground: OSCURA2.url },
    },
    {
      name: 'Decorators',
      scope: [
    ...
    },
    {
      ...
      settings: { fontStyle: 'italic', foreground: OSCURA2.invalid },
    },
    {
      name: 'JSON Keys (All Levels)',
      scope: ['support.type.property-name.json'],
    ...
    },
    {
      name: 'Markup - Italic',
      scope: ['markup.italic'],
      settings: { fontStyle: 'italic', foreground: OSCURA2.text },
    },
    {
      name: 'Markup - Bold',
      scope: ['markup.bold', 'markup.bold string'],
      settings: { fontStyle: 'bold', foreground: OSCURA2.text },
    },
    {
      name: 'Markup - Bold-Italic',
      scope: [
    ...
    },
    {
      name: 'Markup - Underline',
      scope: ['markup.underline'],
      settings: { fontStyle: 'underline', foreground: OSCURA2.tag },
    },
    {
      name: 'Markdown - Blockquote',
      scope: ['markup.quote punctuation.definition.blockquote.markdown'],
    ...
    },
    {
      name: 'Markdown - Raw Block Fenced',
      scope: ['markup.raw.block.fenced.markdown'],
      settings: { foreground: OSCURA2.fencedDim },
    },
    {
      name: 'Markdown - Fenced Bode Block',
      scope: ['punctuation.definition.fenced.markdown'],
    ...
    },
    {
      name: 'Markdown - Separator',
      scope: ['meta.separator'],
      settings: { fontStyle: 'bold', foreground: OSCURA2.mdSeparator },
    },
    {
      name: 'Markup - Table',
      scope: ['markup.table'],
    ...
    },
    {
      ...
      settings: { foreground: OSCURA2.bracket },
    },
    {
      name: 'Next.js Directives',
      scope: [
    ...
    // -------------------------------------------------------------------------
    {
      ...
      settings: { foreground: OSCURA2.tag, fontStyle: 'bold' },
    },
    {
      name: 'Python Function Arguments',
      scope: ['variable.parameter.function.python'],
      settings: { foreground: OSCURA2.neutral, fontStyle: 'italic' },
    },
    {
      name: 'Python Special Keywords',
      scope: [
    ...
    },
    {
      name: 'Python Docstrings',
      scope: ['string.quoted.docstring.multi.python'],
      settings: { fontStyle: 'italic', foreground: OSCURA2.neutral },
    },
    {
      name: 'Python Built-in Constants',
      scope: ['constant.language.python'],
    ...
    // -------------------------------------------------------------------------
    {
      ...
      settings: { foreground: OSCURA2.strMeaningful },
    },
    {
      name: 'SVG and HTML Attribute Strings',
      scope: [
    ...
    },
    {
      name: 'Template String Text Content',
      scope: ['string.template.js', 'string.template.ts'],
      settings: { foreground: OSCURA2.templateText },
    },
  ],
}
...
export { craft, source_config_default as default }
